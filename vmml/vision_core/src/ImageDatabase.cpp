...
void ImageDatabase::searchDescriptors(
	const cv::Mat& descs,
...
void ImageDatabase::deleteDescriptor(const unsigned desc_id)
{
...
void ImageDatabase::searchDescriptor(
...
void ImageDatabase::insertDescriptor(BinaryDescriptor::Ptr q)
{
	dset_.insert(q);
...
void ImageDatabase::deleteDescriptor(BinaryDescriptor::Ptr q)
{
...
void ImageDatabase::getMatchings(
...
void ImageDatabase::purgeDescriptors(const uint curr_img)
{
